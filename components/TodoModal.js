        ...
        return (
                ...
                <View style={styles.todoContainer}>
                    ...
                    <TouchableOpacity style={styles.deleteButton} onPress={() => this.deleteTodo(index)} >
                        <AntDesign name="delete" size={18} color={colors.black} />
                    </TouchableOpacity>
                </View>
        ...
        return (
            ...
            <SafeAreaView style= {styles.container}>
                ...
                <View style={[styles.section, styles.footer]} >
                    <TextInput style={[styles.input, { borderColor: this.state.color}]} onChangeText onChangeText={text => this.setState({newTodo: text})} value={this.state.newTodo} />
